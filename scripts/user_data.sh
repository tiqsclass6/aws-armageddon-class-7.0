...
SECRET_ID="${SECRET_ID:-lab/rds/mysql_v21}"
...
def home():
    return """
    <h2>Private EC2 → RDS Notes App (Bonus B)</h2>
    <p><a href="/init">/init</a> – initialize database</p>
    <p>/add?note=hello</p>
    <p><a href="/list">/list</a></p>
    <small>Now publicly accessible via ALB (HTTPS) - https://app.theinternationalquietstorm.net/</small>
    """
