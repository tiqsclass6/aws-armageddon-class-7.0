...
Final Note (GET): https://${aws_cloudfront_distribution.liberdade_cf.domain_name}/add?note=lab_3a_is_complete
...
output "shinjuku_db_secret_arn" {
  ...
  value       = aws_secretsmanager_secret.shinjuku_db_creds_v9.arn
}
