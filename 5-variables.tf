...
variable "enable_bonus_g_bedrock_auto_ir" {
  description = "Enable Bonus G Bedrock auto incident report pipeline."
  type        = bool
  default     = true
}

variable "enable_bonus_g_logs_insights_queries" {
