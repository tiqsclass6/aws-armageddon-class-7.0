# WAF A1 (top actions)
resource "aws_cloudwatch_query_definition" "bonus_f_waf_a1_top_actions" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
...
resource "aws_cloudwatch_query_definition" "bonus_f_waf_a2_top_client_ips" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
...
# WAF A3 (top URIs)
resource "aws_cloudwatch_query_definition" "bonus_f_waf_a3_top_uris" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
...
# WAF A4 (blocked only)
resource "aws_cloudwatch_query_definition" "bonus_f_waf_a4_blocked_only" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
...
resource "aws_cloudwatch_query_definition" "bonus_f_waf_a5_blocking_rule" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
...
resource "aws_cloudwatch_query_definition" "bonus_f_waf_a6_suspicious_scanners" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
...
resource "aws_cloudwatch_query_definition" "bonus_f_waf_a8_country" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
...
resource "aws_cloudwatch_query_definition" "bonus_f_app_b1_errors_over_time" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
...
resource "aws_cloudwatch_query_definition" "bonus_f_app_b2_recent_db_failures" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
...
# APP B3 (classifier)
resource "aws_cloudwatch_query_definition" "bonus_f_app_b3_classifier" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
...
# APP B4 (JSON logs)
resource "aws_cloudwatch_query_definition" "bonus_f_app_b4_json_error_fields" {
  count = var.enable_bonus_f_logs_insights_queries ? 1 : 0
