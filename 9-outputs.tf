...
First note:     https://${local.zone_name}/add?note=test_from_bonus_g
...
Fifth note:     https://${local.zone_name}/add?note=lab_1c_bonus_g_is_successful
